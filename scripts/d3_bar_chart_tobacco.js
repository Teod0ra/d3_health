...
function drawGraph(data) {
  ...
  x.domain(data.map(function(d) { return d.graphYear; }));
  y.domain([0, d3.max(data, function(d) { return d.graphValue; })]);
  ...
  svg.selectAll("bar")
    ...
    .attr("x", function(d) { return x(d.graphYear); })
    .attr("width", x.rangeBand())
    .attr("y", function(d) { return y(d.graphValue); })
    .attr("height", function(d) { return height - y(d.graphValue); });
}
